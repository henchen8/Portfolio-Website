    ...
    const unsubscribe = onAppReady(() => {
      modulePromise.then(({ default: WebGLFluid }) => {
        ...
        WebGLFluid(canvas, {
          ...
          SPLAT_RADIUS: 0.45,
          // Vorticity/swirliness — library default is 30; lowered for a
          // calmer, less turbulent flow.
          CURL: 12,
          // This renderer derives on-screen opacity from the splat color's
          // own brightness (alpha = max(r,g,b)), so a dark, neutral gray is
          // nearly invisible against a light page — this near-neutral tone
          // is as close to greyscale as it can get while staying visible.
          SPLAT_COLOR: { r: 0.65, g: 0.67, b: 0.72 },
          COLORFUL: false,
          SHADING: false,
