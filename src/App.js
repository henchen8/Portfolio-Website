        ...
        <section id="projects" className="section projects-section">
          <div className="container">
            ...
            <div className="projects-list">
              <div className="project-entry" onClick={() => window.open('https://www.youtube.com/shorts/J1a7RxK03xU', '_blank', 'noopener,noreferrer')}>
                <div className="project-meta">Onshape · Fusion · Arduino · Python · C++</div>
                <h3>Rubik's Cube Robot</h3>
                <p>
                  Fully modular cube-solving robot with average solve times just over a second.
                </p>
                <div className="project-links" onClick={(e) => e.stopPropagation()}>
                  <a href="https://www.youtube.com/shorts/J1a7RxK03xU" target="_blank" rel="noopener noreferrer" className="project-link">Live Demo</a>
                  <a href="https://cad.onshape.com/documents/e64e9adb0ff9466627b47f67/w/74a34c291195daf66dba9b40/e/ef19ed1914f1db15c2699f69" target="_blank" rel="noopener noreferrer" className="project-link">CAD</a>
                  <a href="https://docs.google.com/presentation/d/12Rsq6fVtxUd_KKTxoM-D5vIqgpLokWzd/edit?slide=id.p1#slide=id.p1" target="_blank" rel="noopener noreferrer" className="project-link">Slides</a>
                </div>
              </div>

              <div className="project-entry" onClick={() => window.open('https://youtu.be/doYoJWpjqiU', '_blank', 'noopener,noreferrer')}>
                <div className="project-meta">Financial Derivatives · PC Analysis · Numerical Methods · Linear Algebra · Differential Equations</div>
                ...
                <div className="project-links" onClick={(e) => e.stopPropagation()}>
                  <a href="https://youtu.be/doYoJWpjqiU" target="_blank" rel="noopener noreferrer" className="project-link">Live Presentation</a>
                  <a href="https://docs.google.com/presentation/d/129P1cS45KJAWDq-8KD_RfFEJdXTyp73k/edit?slide=id.p1#slide=id.p1" target="_blank" rel="noopener noreferrer" className="project-link">Slides</a>
                  <a href="https://docs.google.com/document/d/1O5VnQPQPrbvbTIRUn-OBa9-4rOL6O1LAE2362aLJe6o/edit?tab=t.0" target="_blank" rel="noopener noreferrer" className="project-link">Research Notes</a>
                </div>
              </div>

              <div className="project-entry" onClick={() => window.open('https://youtu.be/JnfntLZAGBE', '_blank', 'noopener,noreferrer')}>
                <div className="project-meta">Financial Modelling · Onshape · Figma · C · Arduino</div>
                <h3>FitBox</h3>
                <p>
                  A revolutionary portable workout solution.
                </p>
                <div className="project-links" onClick={(e) => e.stopPropagation()}>
                  <a href="https://youtu.be/JnfntLZAGBE" target="_blank" rel="noopener noreferrer" className="project-link">Live Demo</a>
                  <a href="https://docs.google.com/presentation/d/1XXMJS2hofXJqpHwX3uvxKPht97CCMyoBtOF3lLLi4Bc/edit?usp=sharing" target="_blank" rel="noopener noreferrer" className="project-link">Slides</a>
                  <a href="https://cad.onshape.com/documents/cfd0d20e2c53157ccca464c4/w/7b40b5013232732c438b29e9/e/784c86c2b4418326fd73f6e6" target="_blank" rel="noopener noreferrer" className="project-link">CAD</a>
                  <a href="https://docs.google.com/spreadsheets/d/1uZ32Qh6mbSQrWwkWwTfcECNh_2IvQMew/edit?usp=sharing&ouid=108470188565309865197&rtpof=true&sd=true" target="_blank" rel="noopener noreferrer" className="project-link">Financial Modelling</a>
                  <a href="https://docs.google.com/document/d/16BLjd1bWl2OHBLal30bFIdV5pIzva3wmQyLRJ9i1YFM/edit?tab=t.0" target="_blank" rel="noopener noreferrer" className="project-link">Executive Summary</a>
                </div>
              </div>
            </div>
          </div>
